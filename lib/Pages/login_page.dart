  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(child: Column(
        ...
        SubmitButton(text: 'LOGIN', onPressed: () =>Navigator.push(
          context, MaterialPageRoute(builder: (context) => const CircularNavigationBar())),
          color1: amber,color2: pink,),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
       ...
       crossAxisAlignment: CrossAxisAlignment.start,
          children:  [
            Center(child: Image.asset("assets/images/Logo2.png" , width: 150, height:120,)),
            const SizedBox(height: 10,),
            const Text("Login ", style: TextStyle(fontSize:23, fontWeight: FontWeight.bold),),
            const SizedBox(height:8,),
             Text("Login to your account", style: TextStyle(color: textFieldGrey,fontSize:15, fontWeight: FontWeight.bold),),
            const SizedBox(height:20,),
            ...
            const SizedBox(height:30,) ,
            Center(
              child: SubmitButton(text: 'LOGIN', onPressed: () =>Navigator.push(
                  context, MaterialPageRoute(builder: (context) => const CircularNavigationBar())),
                color1: amber,color2: pink,),
            ),
            const SizedBox(height:10,),
